...
#   c) node1 mines 32 blocks, so now node 0 has 60001prcy, node 1 has 4250prcy, node2 has none.
#   d) node0 sends 601 prcy to node2, in two transactions (301 prcy, then 300 prcy).
