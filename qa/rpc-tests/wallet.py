...
#   c) node1 mines 32 blocks, so now node 0 has 60001daps, node 1 has 4250daps, node2 has none.
#   d) node0 sends 601 daps to node2, in two transactions (301 daps, then 300 daps).
