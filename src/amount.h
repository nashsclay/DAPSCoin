...
/** No amount larger than this (in PRCY) is valid in a single UTXO.
 *
 * Note that this constant is *not* the total money supply, which in PRCY
 ...
 */
static const CAmount MAX_MONEY_OUT = 70000000 * COIN;
