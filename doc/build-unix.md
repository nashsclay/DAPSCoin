...
memory available when compiling PRCYCoin. On systems with less, gcc can be
...
above instead of `libssl-dev`. PRCYCoin does not support the use of OpenSSL 1.1, though compilation is still possible
...
To build PRCYCoin without wallet, see [*Disable-wallet mode*](/doc/build-unix.md#disable-wallet-mode)
...
Build requirements:
    ...
    sudo dnf install which gcc-c++ libtool make autoconf automake compat-openssl10-devel libevent-devel boost-devel libdb4-devel libdb4-cxx-devel python3
...
Security
--------
To help make your PRCYCoin installation more secure by making certain attacks impossible to
