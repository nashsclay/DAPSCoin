...
In order to support loading of multiple wallets in prcycoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is prcycoin.cpp.
...
Changes to prcycoin.cpp
----------------------
prcycoin.cpp is the entry point into prcycoin-qt, and as such, will require some minor modifications to provide hooks for
