...
In order to support loading of multiple wallets in dapscoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is dapscoin.cpp.
...
Changes to dapscoin.cpp
----------------------
dapscoin.cpp is the entry point into dapscoin-qt, and as such, will require some minor modifications to provide hooks for
