...
The script [extract-osx-sdk.sh](https://github.com/prcycoin/prcycoin/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
prcycoin/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/prcycoin/prcycoin/blob/master/doc/README_osx.md) for troubleshooting tips.