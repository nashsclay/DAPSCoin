...
The build script we'll be using is contained in the PRCYCoin github repository ([contrib/gitian-build.py](https://github.com/prcycoin/prcycoin/blob/master/contrib/gitian-build.py)). Since this is a completely fresh environment, we haven't yet cloned the PRCYCoin repository and will need to fetch this script with the following commands:

```bash
curl -L -O https://raw.githubusercontent.com/PRCYCoin/PRCYCoin/master/contrib/gitian-build.py
...
- Clone the gitian-builder, gitian.sigs, prcycoin-detached-sigs, and prcycoin GitHub repos.
