...
1. Clone the PRCYCoin source code:

        git clone https://github.com/prcycoin/prcycoin
        cd prcycoin
...
When the intention is to run only a P2P node without a wallet, PRCYCoin may be compiled in
...
PRCYCoin is now available at `./src/prcycoind`

Before running, you may create an empty configuration file:

    mkdir -p "/Users/${USER}/Library/Application Support/PRCYCoin"

    touch "/Users/${USER}/Library/Application Support/PRCYCoin/prcycoin.conf"

    chmod 600 "/Users/${USER}/Library/Application Support/PRCYCoin/prcycoin.conf"

The first time you run prcycoind, it will start downloading the blockchain. This process could take many hours, or even days on slower than average systems.
...
-------
    ...
    ./src/prcycoind -daemon # Starts the prcycoin daemon.
    ./src/prcycoin-cli --help # Outputs a list of command-line options.
    ./src/prcycoin-cli help # Outputs a list of RPC commands when the daemon is running.
