...
```
// Copyright (c) <firstYear>-<lastYear> The PRCYCoin developers
```
will be updated to:
```
// Copyright (c) <firstYear>-<lastModifiedYear> The PRCYCoin developers
```
...
those cases:
```
// Copyright (c) <year> The PRCYCoin developers
```
will be updated to:
```
// Copyright (c) <year>-<lastModifiedYear> The PRCYCoin developers
```
