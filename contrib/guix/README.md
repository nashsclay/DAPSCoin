# Bootstrappable PRCYcoin Builds

This directory contains the files necessary to perform bootstrappable PRCYcoin
builds.
...
- 24GB of free disk space on the partition that the prcycoin repository resides in
...
For a PRCYcoin depends development environment, simply invoke
...
From the top of a clean PRCYcoin repository:
...
To use dongcarl's substitute server for PRCYcoin builds after having
