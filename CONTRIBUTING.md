...
The PRivaCY Coin Developers operates an open contributor model where anyone is
...
The following applies to code changes to the PRCY project, and is not to be
