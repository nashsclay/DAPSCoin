Contributing to DAPScoin
============================

The DAPScoin project operates an open contributor model where anyone is
...
The following applies to code changes to the DAPScoin project, and is not to be
confused with overall DAPScoin Network Protocol consensus changes.

Whether a pull request is merged into DAPScoin rests with the project merge
...
The project leader is the release manager for each DAPScoin release.
